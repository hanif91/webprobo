  ...
  return (
    <>
      ...
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Stay Tune Terus di Media Sosial Kami untuk mendapat update Terbaru dari Perumda Air Minum Bayuangga Kota Probolinggo.
                </p>
        ...
        <div className="bg-primary2/10 py-4">
          <div className="container">
            <p className="text-center text-sm text-gray-700 dark:text-white">
              ©Copyright Perumda Air Minum Bayuangga Kota Probolinggo. All Rights Reserved
            </p>
          </div>
        </div>
